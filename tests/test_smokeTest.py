...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1490, 1000)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("user")
    self.driver.find_element(By.ID, "password").send_keys("posfs")
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Ryndee")
    self.driver.find_element(By.NAME, "lname").send_keys("van Langeveld")
    self.driver.find_element(By.NAME, "bizname").send_keys("Vash")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Captain")
